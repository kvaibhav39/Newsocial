                ...
                <div>
                    <div className="Column">
                        <div className="wraped">
                            <inpt type="text" placeholder="Your message" disabled={!user} value={message} onChange={(e) => setMessage(e.target.value)}></inpt>
                        </div>
                    </div>
                    <div>
                        <button variant="primary" type="submit" style={{ width: "100%", backgrounddivor: "orange" }} disabled={!user}>
                     Send
                        </button>
                    </div>
                </div>
